...
echo "${CYAN_TEXT}${BOLD_TEXT}     WELCOME TO DR. ABHISHEK'S GCP LAB DEMONSTRATION     ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
echo "${GOLD_TEXT}${BOLD_TEXT}Please Like, Share and Subscribe to the Channel!${RESET_FORMAT}"
echo "${RED_TEXT}${BOLD_TEXT}YouTube: https://www.youtube.com/@drabhishek.5460/videos${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Subscribe to Dr. Abhishek's Channel: https://www.youtube.com/@drabhishek.5460/videos${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}Don't forget to Like, Share and Subscribe for more technical tutorials!${RESET_FORMAT}"
