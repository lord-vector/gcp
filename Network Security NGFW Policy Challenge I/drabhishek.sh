...
echo "${CYAN_TEXT}${BOLD_TEXT}            WELCOME TO DR. ABHISHEK'S GCP LAB            ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Subscribe to Dr. Abhishek: https://www.youtube.com/@drabhishek.5460/videos${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}For more cloud computing and networking tutorials${RESET_FORMAT}"
