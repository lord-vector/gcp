...
echo "${CYAN_TEXT}${BOLD_TEXT}             WELCOME TO DR ABHISHEK TUTORIAL * LIKE THE VIDEO           ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}For more technical tutorials and cloud computing content${RESET_FORMAT}"
