...
echo "${CYAN_TEXT}${BOLD_TEXT}     WELCOME TO DR ABHISHEK TUTORIALS DO LIKE THE VIDEO & SUB THE CHANNEL ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${MAGENTA_TEXT}${BOLD_TEXT}Dr. Abhishek – Subscribe Here: https://www.youtube.com/@drabhishek.5460${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Watch more cloud tutorials on Dr. Abhishek's channel: https://www.youtube.com/@drabhishek.5460${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Support the channel: Dr. Abhishek – https://www.youtube.com/@drabhishek.5460${RESET_FORMAT}"
